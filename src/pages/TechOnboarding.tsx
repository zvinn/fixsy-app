...
export default function TechOnboarding({ user, onComplete }: TechOnboardingProps) {
    ...
    const CLOUD_NAME = import.meta.env.VITE_CLOUDINARY_CLOUD_NAME || "dfi5x5u1e"; // Fallback or env
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>, type: 'id' | 'portfolio') => {
