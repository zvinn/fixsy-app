...
import { CheckCircle, MapPin, Calendar, CreditCard, ChevronRight, Home, FileText } from 'lucide-react';
...
interface BookingSuccessProps {
    details: {
        ...
        serviceType?: string;  // Optional - component handles fallback
...
const BookingSuccess: React.FC<BookingSuccessProps> = ({ details, onClose, onTrack }) => {
    ...
    return (
        <div style={{
            ...
            <div className="glass-panel" style={{
                background: 'var(--glass)', borderRadius: '24px', padding: '30px',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    ...
                    <button onClick={() => generateReceiptPDF(details, t, language)} style={{
                        background: '#10B981', color: 'white', padding: '14px', borderRadius: '12px',
                        border: 'none', fontWeight: 'bold', fontSize: '1rem', cursor: 'pointer',
                        display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
                        boxShadow: '0 4px 15px rgba(16, 185, 129, 0.3)'
                    }}>
                        <FileText size={18} /> {t("downloadReceipt") || "Download Receipt"}
                    </button>
